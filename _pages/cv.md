...
* Nov 1, 2023 - May 27, 2025: Project Associate I and II, Hardware Security Research Group (HSRG), SETS, Chennai.
  ...
  * Outcomes:
    * Evaluated the Independent and Identically Distributed (IID) claim made by the collaborator on RO based TRNG, and based on testing data, provided constructive feedback and alternative approaches that can lead to a more robust and reliable TRNG for PQC-PKI.
